...
#define MCPPALLOC_CONCURRENCY_LOCK_GUARD_LABEL_(a) MCPPALLOC_CONCURRENCY_LOCK_GUARD_MERGE_(mcpputil_concurrency_lock_guard_, a)
...
#define MCPPALLOC_CONCURRENCY_LOCK_ASSUME_LABEL_(a) MCPPALLOC_CONCURRENCY_LOCK_ASSUME_MERGE_(mcpputil_concurrency_lock_assume_, a)
#define MCPPALLOC_CONCURRENCY_LOCK_ASSUME_VARIABLE MCPPALLOC_CONCURRENCY_LOCK_ASSUME_LABEL_(__LINE__)
#define MCPPALLOC_CONCURRENCY_LOCK_GUARD(x) ::mcpputil::lock_guard_t<decltype(x)> MCPPALLOC_CONCURRENCY_LOCK_GUARD_VARIABLE(x);
#define MCPPALLOC_CONCURRENCY_LOCK2_GUARD(x, y)                                                                                  \
  ::mcpputil::lock_guard2_t<decltype(x), decltype(y)> MCPPALLOC_CONCURRENCY_LOCK_GUARD_VARIABLE(x, y);
